    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='inspectores.cargo')),
                ('institucion', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='inspectores.institucion')),
            ],
            options={
